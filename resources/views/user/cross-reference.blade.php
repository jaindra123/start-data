...
<div class="main-panel">
    ...
    <div class="content quereszz">
            ...
            <div class="col-md-6">
                <ul class="nav nav-tabs">
                    ...
                    <span class="ml-4 float-right ttttt">
                        <span class="tyur mr-3"><img src="{{asset('assets/img/5.svg')}}" class="mr-2 ml-2">Compare</span>
                        <div class="tyurd">
                            <div class="wrappers">
        ...
        <div class="alert alert-warningss alert-dismissible fade show mt-5 mb-5" role="alert">
            ...
            <div class="row mt-4 mb-0">
                <div class="col-md-6">
                    <button class="custom-button"><img src="{{asset('assets/img/7.svg')}}">Export All</button>
                </div>
                <div class="col-md-6">
                    <button class="custom-button"><img src="{{asset('assets/img/7.svg')}}"> Only Selected</button>
                </div>
            </div>
        </div>
        ...
        <div class="alert alert-warningss alert-dismissible fade show mt-5 mb-5" role="alert">
            ...
            <div class="row mt-4 mb-0">
                <div class="col-md-6">
                    <button class="custom-button"><img src="{{asset('assets/img/8.svg')}}">Export All</button>
                </div>
                <div class="col-md-6">
                    <button class="custom-button"><img src="{{asset('assets/img/8.svg')}}"> Only Selected</button>
                </div>
            </div>
        </div>
        ...
        <div class="alert alert-warningss alert-dismissible fade show mt-5 mb-5" role="alert">
            ...
            <div class="row mt-4 mb-0">
                <div class="col-md-6">
                    <button class="custom-button">German</button>
                </div>
                <div class="col-md-6">
                    <button class="custom-button">English</button>
                </div>
            </div>
        </div>
    </div>
